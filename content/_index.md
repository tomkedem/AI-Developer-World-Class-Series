...
ברוך הבא לסדרת ספרים שבנויה במיוחד למפתחות ולמפתחים שעובדים בעידן ה-AI.  
המטרה היא להציג רעיונות וטכניקות בצורה פשוטה, פרקטית ונגישה, בלי העמסות ובלי דרישות מוקדמות מיותרות.

כל ספר מתמקד בנושא שונה, ויחד הם יוצרים בסיס עבודה ברור למי שרוצה להבין איך לחשוב, לפתח ולבנות מערכות בעולם ה-AI.
