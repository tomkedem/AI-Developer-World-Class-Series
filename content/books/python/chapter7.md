...
**קידוד אחיד (UTF-8), בדיקות קיום קבצים,**ו-**קונפיגורציה חיצונית**שמאפשרת לשנות פרמטרים בלי לגעת בשורה אחת של קוד.
...
```
    """קורא dataset ומחזיר גרסה נקייה"""
```python
...
מתכנתים צעירים מתלהבים מקוד רץ.
