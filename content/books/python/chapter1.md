...
שכבר בנה מערכות אמיתיות, אבל רוצה להבין איך פייתון הפכה לשפה שמנהלת היום כמעט כל מערכת בינה מלאכותית רצינית. 
  ...
  המטרה הראשונה של הספרון הזה היא **ללמד אותך לחשוב כמו מהנדס AI**, לא כמו “מתכנת מתחיל בפייתון”.
...
בסוף הספרון הזה תדע לא רק לכתוב קוד שעובד, אלא לכתוב קוד **שאפשר לבנות עליו מערכת שלמה**:
...
זו בדיוק החשיבה שתרצה לאמץ לאורך כל הספרון:
