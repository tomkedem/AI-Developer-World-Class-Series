---
title: "פרק 18 – (בונוס) תבנית פרויקט למתכנת AI"
weight: 19
---
...
גם פרויקט קטן שמתחיל בתיקייה אחת, עדיף שייבנה כשלד המתאים ל-production מהיום הראשון.
...
זו הדרך הנכונה להפוך פרויקט AI מתהליך ידני למערכת שניתנת להרצה מתוזמנת.
...
תיעוד הוא חלק מהקוד.
כל מודול צריך **docstring ברור**, וכל פרויקט צריך **README.md קצר וקריא**: 
- מה הכלי עושה
- איך מתקינים
- איך מריצים  
...
## Best Practices
 ...
 ✔ עדכנו את התלויות בקובץ requirements.txt באופן קבוע.
